...
module.exports = controller => {
  controller.hears([/^pug me/i], 'direct_message,direct_mention,mention,ambient', (bot, message) => {
  ...
  controller.hears([/^pug bomb( (\d+))?/i], 'direct_message,direct_mention,mention,ambient', (bot, message) => {
